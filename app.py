...
# 📌 Do NOT include address, email, phone, or any personal contact details.
# """
...
#         st.warning("⚠️ Please provide both Job Title and Company Name.")
#     else:
...
# else:
#     st.info("👆 Upload a CV and fill out the form to generate your cover letter.")
